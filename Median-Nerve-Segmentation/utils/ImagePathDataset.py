...
class ImagePathDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = Image.open(self.image_path[index]).convert('L')
...
class ImagePathDataset_siam(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        curr_frame = Image.open(self.curr_frame_path[index]).convert('L')
        prev_frame = Image.open(self.prev_frame_path[index]).convert('L')
...
class ImagePathDataset_lstm(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = [self.transform(Image.open(self.image_path[index][i]).convert('L'))
...
class ImagePathDataset_vistr(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return torch.stack(image,dim=0), target
